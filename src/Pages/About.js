...
export default function About(){
    return(
        <>
         ...
         <meta name="description" content="Мы знаем приятный путь к стройному телу - с учетом пожеланий и Вашего образа жизни делаем желанное привычным" />
        <Header page="about" color="#F6EEE0" logo={pic1} paracolor="#000000" background="#0E4952" tcolor="#F6EEEE"/>
        <AboutSection1/>
        <AboutSection2/>
        <AboutSection3/>
        <AboutSection4/>
