  ...
  return (
    <section className="about-section3">
      <div className="aboutsection3-content-container">
        <h1 className="aboutsection3-heading1">
          ...
          <div className="col-lg-4 col-12 col-md-6">
            <div className="ab-sec3-txtc">
              <div className="ab-sec3-txt1">
                ...
                <p>
                  С помощью КПТ можно посмотреть вглубь проблемы и разобраться,
                  как прекратить повторяющееся негативное поведение или мысли.
                </p>
                <p id="abs3-psub1">
                  Депрессия, тревога, пищевые (и другие) зависимости, негативные
                </p>
                <p id="abs3-psub">
                  {" "}
                  мысли, неспособность чувствовать радость — это все симптомы
                  того,
                </p>
              </div>
              <div className="ab-sec3-txt2" id="abs3-t2">
                ...
                <p>
                  В комплексе с поддерживающей психотерапией происходит
                  преображение — уставшая женщина превращается в уверенную,
                  энергичную, гибкую. В заботливых руках наших специалистов
                  женщины заново раскрывают свою внутреннюю силу, обретают
          ...
          <div className="col-12 col-md-12 col-lg-4">
            <div className="ab-sec3-txtc">
              <div className="ab-sec3-txt3">
                <h3>Мы работаем на долгосрочные изменения</h3>
                <p>
                  Психотерапия — это долгий и сложный путь. Мы готовы начать его
                  с вами. Не важно, насколько сильно вы смогли запутаться: мы
                  вместе распутаем клубок ваших проблем.{" "}
                </p>
                <p>
                  Отдохнувшая, уверенная в себе женщина умеет радоваться,
                  прощать и сохранять спокойствие в любой
                </p>
              </div>
